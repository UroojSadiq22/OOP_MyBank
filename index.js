...
class Customers {
    ...
    mobileNumber;
    accountNumber;
    constructor(fName, lName, age, mobNum, accNumber) {
...
async function start() {
    ...
    let customerCheck = customers.find((i) => i.accountNumber.accountNumber === accNumberInput.accNumber);
    if (customerCheck) {
        console.log("\nWelcome", chalk.greenBright.italic(`${customerCheck.firstName} ${customerCheck.lastName}\n`));
            ...
            switch (select.selectOption) {
                case "Withdraw":
                    let withdrawAmount = await inquirer.prompt({
                        name: "value",
                        type: "number",
                        message: chalk.yellow("Enter the amount you wish to withdarw from your account"),
                    });
                ...
                case "Credit":
                    let creditAmount = await inquirer.prompt({
                        name: "value",
                        type: "number",
                        message: chalk.yellow("Enter the amount you wish to credit in your account.\n", chalk.italic.blackBright("Service charges of $1 will be deduct if your credit amount is greater than 100.")),
                    });
